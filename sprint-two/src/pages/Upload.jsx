    ...
    render() {
     ...
     <section className="uploads">
        ...
        <div className="uploads__form-wrap">
            <form onSubmit={this.handleOnSubmit} className="uploads__form" id="uploadsForm" method="post" name="uploadsForm">
            ...
            <label htmlFor="uploadsInput">
              ...
              {/* <button className="uploads__button" id="uploadsDeleteBtn" type="submit">CANCEL</button>  //link to home        */}
