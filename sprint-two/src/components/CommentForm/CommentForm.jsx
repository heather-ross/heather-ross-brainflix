...
function CommentForm({currentVideo, handleCommentSubmit}) {
    ...
    return (
        ...
        <h5 className="comments__counter">{currentVideo.length} Comments</h5>
          <div className="avatar comments__avatar-form"></div>
            <form onSubmit={handleCommentSubmit} className="comments__form" id="commentForm" method="" name="commentForm">
